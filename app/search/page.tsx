    ...
    <div className="min-w-[1400px] bg-white text-[#101725]">
      ...
      <div className="mx-auto max-w-[1360px] px-7 pt-[22px]">
        <div className="mb-1.5 flex items-baseline gap-3">
          ...
          <span className="text-[13.5px] text-[#8A93A3]">
            148 products · 0.21s
          </span>
        </div>
        <div className="mb-5 text-[13px] text-[#8A93A3]">
          Also searched for{" "}
          <span className="cursor-pointer text-[#2563EB]">vitamin c සෙරම්</span>{" "}
          — Sinhala and English content are indexed together, and misspellings
          are tolerated (FR-SRCH-004).
        </div>
        ...
        <div className="grid grid-cols-[250px_1fr] items-start gap-6">
          <div className="overflow-hidden rounded-xl border border-[#E5E8EE] bg-white">
            <div className="border-b border-[#EEF0F4] px-[18px] py-[15px] text-[13px] font-bold">
              Refine
            </div>
            <div className="border-b border-[#EEF0F4] px-[18px] py-3.5">
              <div className="mb-3 text-xs font-semibold">Applied</div>
          ...
          <div>
            <div className="mb-4 flex items-center justify-between rounded-[11px] border border-[#E5E8EE] bg-white px-4 py-3">
              ...
              <div className="flex gap-1.5">
                <span className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-[7px] bg-[#101725] text-[13px] text-white">
                  ▦
                </span>
                <span className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-[7px] border border-[#E5E8EE] text-[13px] text-[#8A93A3]">
                  ☰
                </span>
              </div>
            </div>
      ...
      <div className="fixed bottom-[76px] left-1/2 z-[60] flex -translate-x-1/2 items-center gap-3.5 rounded-xl bg-[#101725] px-4 py-3 shadow-[0_16px_40px_rgba(11,18,32,.32)]">
        ...
        <Link
          href="/compare"
          className="cursor-pointer rounded-lg border-none bg-[#2563EB] px-4 py-2.5 text-[12.5px] font-bold text-white no-underline"
        >
          Compare now
        </Link>
      </div>
