    ...
    <div className="min-w-[1400px] bg-white text-[#101725]">
      ...
      <div className="mx-auto max-w-[1000px] px-7 pt-[30px]">
        <div className="grid grid-cols-[230px_1fr] items-start gap-10">
          ...
          <div>
            <h1 className="mb-2.5 text-[32px] font-bold tracking-[-0.02em]">
              Returns &amp; refunds policy
            </h1>
            <div className="mb-7 text-[13px] text-[#8A93A3]">
              Last updated 01 June 2026 · governs all orders placed on
              koshimamall.lk
            </div>
            <div className="mb-7 rounded-xl border border-[#F5E0BC] bg-[#FDF3E4] p-[16px_20px] text-[12.5px] leading-relaxed text-[#8A5A0B]">
              The return window and who pays return shipping are configurable
              per category and remain open for client confirmation (Appendix B
              #9). The values shown are the platform defaults.
            </div>
            {POLICY_SECTIONS.map((p) => (
              <div key={p.h} className="mb-7">
                ...
                <p className="text-[14.5px] leading-relaxed text-pretty text-[#48505E]">
                  {p.b}
                </p>
              </div>
            ))}
