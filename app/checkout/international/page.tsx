      ...
      <div className="mx-auto max-w-[1160px] px-7">
        <div className="grid grid-cols-[1fr_348px] items-start gap-6">
          <div className="grid gap-3.5">
            <div className="rounded-xl border border-[#E5E8EE] bg-white p-[22px_24px]">
              ...
              <div className="mb-[18px] grid grid-cols-[1.4fr_1fr_1fr] gap-3.5">
                <div>
                  ...
                  <div className="flex items-center justify-between rounded-lg border-2 border-[#101725] px-3.5 py-3 text-[13px] font-semibold">
                    United Kingdom
              ...
              <div className="rounded-[9px] bg-[#EEF3FE] px-[15px] py-3.5 text-[12.5px] leading-relaxed text-[#2B4C8C]">
                Rates come from the Sri Lanka Post Foreign Postage schedule
                effective 01 Aug 2022, version{" "}
                <span className="font-mono">v2022.08</span>. Volumetric weight
                is compared against actual and the greater is charged.
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-xl border border-[#E5E8EE] bg-white">
              <div className="flex items-center justify-between border-b border-[#EEF0F4] p-[18px_24px]">
                <div className="text-base font-bold">
                  Available services to United Kingdom
                </div>
                <span className="font-mono text-[11.5px] text-[#98A1AF]">
                  2 services hidden — over weight limit
                </span>
              </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="mb-1.5 flex items-center gap-2">
                      ...
                      {s.tag ? (
                        <span
                          className={`rounded px-1.5 py-1 text-[9.5px] font-semibold ${TAG_TONE[s.tagTone]}`}
                        >
                          {s.tag}
                        </span>
                      ) : null}
                    </div>
                    <div className="mb-1.5 text-[12.5px] text-[#8A93A3]">
                      {s.detail}
                    </div>
                  ...
                  <div className="text-right">
                    <div className="text-[16px] font-extrabold">{s.price}</div>
                    <div className="mt-1.5 font-mono text-[11px] text-[#B3BAC6]">
                      {s.days}
                    </div>
                  </div>
                </div>
            ...
            <div className="rounded-xl border border-[#E5E8EE] bg-white p-[22px_24px]">
              <div className="mb-1.5 text-base font-bold">Special services</div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {SPECIAL_FEES.map((f) => (
                  <div
                    key={f.name}
                    className="flex items-center gap-2.5 rounded-[9px] border border-[#E5E8EE] p-[13px_15px]"
                  >
                    <div
            ...
            <div className="rounded-xl border border-[#F5E0BC] bg-[#FDF3E4] p-[18px_22px]">
              <div className="mb-2 flex items-center gap-2.5">
                ...
                <span className="text-[13.5px] font-bold text-[#8A5A0B]">
                  Customs duties and import taxes
                </span>
              </div>
              <div className="text-[12.5px] leading-relaxed text-[#8A5A0B]">
                Duties for the United Kingdom are payable by the recipient on
                delivery (DDU). A commercial invoice with declared value Rs
                21,320 and HS codes 3304.99 / 3401.30 will travel with the
                parcel.{" "}
                <span className="opacity-75">
                  Appendix B #4 — switch to DDP and this panel becomes an
                  itemised estimate at checkout instead.
                </span>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-[#E5E8EE] bg-white p-[20px_22px]">
              ...
              {INTL_SUMMARY.map((r) => (
                <div key={r.k} className="mb-2.5 flex justify-between">
                  ...
                  <span
                    className={`text-[13px] font-semibold ${SUMMARY_TONE[r.tone]}`}
                  >
                    {r.v}
                  </span>
                </div>
              ...
              <div className="mt-1 flex items-baseline justify-between border-t border-[#EEF0F4] pt-3.5">
                ...
                <span className="text-xl font-extrabold">Rs 25,110</span>
              </div>
