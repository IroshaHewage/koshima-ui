        ...
        <div className="grid grid-cols-[1fr_348px] items-start gap-6">
          <div className="grid gap-3.5">
            <div className="rounded-xl border border-[#E5E8EE] bg-white p-[22px_24px]">
              <div className="mb-[18px] font-bold text-base">Pay with your wallet</div>
              <div className="flex items-center gap-3.5 rounded-[10px] border border-[#E5E8EE] p-[16px_18px]">
                <div className="flex h-[17px] w-[17px] flex-none items-center justify-center rounded-md bg-[#2563EB] text-[10px] text-white">✓</div>
                <div className="flex-1">
                  <div className="mb-1.5 font-bold text-[13.5px]">Koshima Wallet</div>
                  <div className="text-[12.5px] text-[#8A93A3]">Balance Rs 1,820 · applied in full to this order</div>
                </div>
                <div className="font-extrabold text-[15px] text-[#12805C]">− Rs 1,820</div>
              </div>
            </div>

            <div className="overflow-hidden rounded-xl border border-[#E5E8EE] bg-white">
              <div className="border-b border-[#EEF0F4] p-[18px_24px] font-bold text-base">Payment method</div>
              {PAY_GROUPS.map((g, gi) => (
                <div key={g.label} className={`p-[18px_24px] ${gi !== PAY_GROUPS.length - 1 ? "border-b border-[#F3F5F8]" : ""}`}>
                    ...
                    {g.methods.map((m) => (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="mt-1 text-[10.5px] text-[#98A1AF]">{m.sub}</div>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <div className="bg-[#F8FAFF] p-[20px_24px]">
                <div className="mb-3.5 font-semibold text-[12.5px]">Koko — 3 instalments</div>
                <div className="mb-3.5 grid grid-cols-3 gap-2.5">
                  {[
                    ...
                    >
                      <div className="font-bold text-[15px]">{amt}</div>
                      <div className="mt-1.5 text-[11px] text-[#8A93A3]">{when}</div>
                    </div>
                  ))}
                </div>
                <div className="text-[11.5px] text-[#8A93A3]">
                  0% interest · approval by Koko · instalment provider is Appendix B #2, pending
                  client confirmation.
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 rounded-xl bg-[#F6F7F9] p-[16px_20px]">
              ...
              <div className="flex-1 text-[12.5px] leading-relaxed text-[#6B7280]">
                Card details are captured on the gateway and tokenised. Koshima never stores raw
                card data, keeping PCI-DSS scope minimal (FR-PAY-009, NFR-SEC-005).
              </div>
            </div>
          ...
          <div className="sticky top-6 rounded-xl border border-[#E5E8EE] bg-white p-[20px_22px]">
            ...
            <div className="mt-1 flex items-baseline justify-between border-t border-[#EEF0F4] pt-3.5">
              <span className="font-bold text-sm">Due now</span>
