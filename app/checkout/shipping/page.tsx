...
import { CART_SUMMARY, SHIP_OPTIONS, SHIP_SUBORDER_2 } from "@/lib/storefront/data"
        ...
        <div className="grid grid-cols-[1fr_348px] items-start gap-6">
          <div className="grid gap-3.5">
            <div className="flex items-center gap-3.5 rounded-xl border border-[#E5E8EE] bg-white p-[18px_22px]">
              <span className="font-mono text-[11px] font-semibold text-[#98A1AF]">SHIP TO</span>
              <span className="text-[13px] font-medium">
                Nimasha Perera · No. 42/3, Kandy Road, Kurunegala 60000, Sri Lanka
              </span>
              <Link href="/checkout/address" className="ml-auto cursor-pointer font-semibold text-[12.5px] text-[#2563EB] no-underline">
                Change
              </Link>
            </div>

            <div className="rounded-xl border border-[#E5E8EE] bg-white p-[22px_24px]">
              <div className="mb-1.5 font-bold text-base">Delivery — sub-order 1 of 2</div>
              <div className="mb-[18px] text-[12.5px] text-[#8A93A3]">
                Ayurma Herbals, Kurunegala · 3 items · chargeable weight 0.60 kg · courier: Fardar
                Express only
              </div>
              {SHIP_OPTIONS.map((o) => (
                <div
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="mb-1.5 flex items-center gap-2">
                      <span className="font-bold text-[13.5px]">{o.name}</span>
                      {o.tag ? (
                  ...
                  <div className={`font-extrabold text-[15px] ${o.free ? "text-[#12805C]" : ""}`}>{o.price}</div>
                </div>
              ))}
              <div className="mt-4 rounded-[9px] bg-[#F6F7F9] p-[14px_16px]">
                ...
                <div className="grid grid-cols-4 gap-3.5">
                  {[
                    ...
                    <div key={k}>
                      <div className="mb-1.5 font-mono text-[11px] text-[#98A1AF]">{k}</div>
                      <div className="font-semibold text-[13px]">{v}</div>
                    </div>
                  ))}
                  <div>
                    <div className="mb-1.5 font-mono text-[11px] text-[#98A1AF]">FREE-SHIP RULE</div>
                    <div className="font-semibold text-[13px] text-[#12805C]">Applied &gt; Rs 10,000</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-[#E5E8EE] bg-white p-[22px_24px]">
              <div className="mb-1.5 font-bold text-base">Delivery — sub-order 2 of 2</div>
              <div className="mb-[18px] text-[12.5px] text-[#8A93A3]">
              ...
              <div className="flex items-center gap-3.5 rounded-[10px] border-2 border-[#101725] p-[16px_18px]">
                ...
                <div className="flex-1">
                  <div className="mb-1.5 font-bold text-[13.5px]">{SHIP_SUBORDER_2.name}</div>
                  <div className="text-[12.5px] text-[#8A93A3]">{SHIP_SUBORDER_2.detail}</div>
                </div>
                <div className="font-extrabold text-base">{SHIP_SUBORDER_2.price}</div>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-1">
                <div className="mb-1.5 font-bold text-[13.5px] text-white">Shipping outside Sri Lanka?</div>
                <div className="text-[12.5px] text-white/55">
                  Switch the destination country to rate against Sri Lanka Post services
                </div>
              </div>
              <span className="font-semibold text-[12.5px] text-[#7FA6F5]">See international rating →</span>
            </Link>

            <div className="flex items-center justify-between">
              <Link href="/checkout/address" className="text-[13px] font-semibold text-[#48505E] no-underline">
                ← Back to address
              </Link>
              <Link
