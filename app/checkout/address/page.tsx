          ...
          <div className="grid gap-3.5">
            <div className="rounded-xl border border-[#E5E8EE] bg-white p-[22px_24px]">
              <div className="mb-[18px] flex items-center justify-between">
                <div className="text-base font-bold">Delivery address</div>
                <span className="cursor-pointer text-[12.5px] font-semibold text-[#2563EB]">
                  + Add new address
                </span>
              </div>
              {ADDRESSES.map((a) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="mb-1.5 flex items-center gap-2">
                      ...
                      <span
                        className={`rounded px-1.5 py-1 text-[9.5px] font-semibold ${TAG_TONE[a.tagTone]}`}
                      >
                        {a.tag}
                      </span>
                    </div>
                    <div className="text-[13px] leading-relaxed text-[#48505E]">
                      {a.line}
                    </div>
                    <div className="mt-2 font-mono text-[12.5px] text-[#8A93A3]">
                      {a.phone}
                    </div>
                  </div>
                  <span className="cursor-pointer text-xs font-semibold text-[#8A93A3]">
                    Edit
                  </span>
                </div>
              ))}
            ...
            <div className="rounded-xl border border-[#E5E8EE] bg-white p-[22px_24px]">
              ...
              <div className="mb-5 text-[12.5px] leading-relaxed text-[#8A93A3]">
                Country, province, district, city and town come from the managed
                location hierarchy — dropdowns cascade (FR-LOC-001, FR-LOC-002).
              </div>
              ...
              <div className="mt-[18px] flex items-center gap-2.5">
                ...
                <span className="text-[13px] text-[#48505E]">
                  Save to my address book and make it the default
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 rounded-xl bg-[#EEF3FE] p-[18px_22px]">
              <div className="flex-1 text-[13px] leading-relaxed text-[#2B4C8C]">
                Checking out as a guest? You can place this order without an
                account and convert it afterwards from the confirmation email
                (FR-AUTH-011).
              </div>
              <button className="cursor-pointer rounded-lg border border-[#C7D8FA] bg-white px-4 py-3 text-[12.5px] font-semibold whitespace-nowrap text-[#2563EB]">
                Continue as guest
              </button>
            </div>
            ...
            {MINI_CART.map((i) => (
              <div key={i.name} className="mb-3.5 flex gap-3">
                <div className="relative h-[50px] w-[50px] flex-none overflow-hidden rounded-lg">
                  ...
                  />
                  <div className="absolute -top-1.5 -right-1.5 rounded-full bg-[#101725] px-1.5 py-1 text-[9.5px] font-bold text-white">
                    {i.qty}
                  </div>
                </div>
                <div className="flex-1">
